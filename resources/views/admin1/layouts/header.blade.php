...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">حساباتي</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
			  <li class="nav-item">
                <a href="{{url('admin/store/categorylist')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>تصنيف المنتجات</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/store/storelist')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>إدارة المخازن</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{url('admin/store/productlist')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>إدارة المنتجات</p>
                </a>
              </li>
