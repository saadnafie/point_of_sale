...
Route::group([
    ...
    Route::group([
        ...
        //   Route::get('sales_reports', 'SaleBillController@sale_report');
        //   Route::post('sales_reports', 'SaleBillController@sale_report_date');
        //   Route::get('purchases_reports', 'PurchaseBillController@sale_report');
        //   Route::post('purchases_reports', 'PurchaseBillController@sale_report_date');
